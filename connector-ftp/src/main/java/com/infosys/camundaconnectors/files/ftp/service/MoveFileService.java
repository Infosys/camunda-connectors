...
public class MoveFileService implements FTPRequestData {
  ...
  @NotBlank private String sourceFolderPath;
  @NotBlank private String sourceFileName;
  ...
  public int hashCode() {
    return Objects.hash(
        actionIfFileExists, sourceFolderPath, sourceFileName, targetFolderPath, actionIfFileExists);
  }
