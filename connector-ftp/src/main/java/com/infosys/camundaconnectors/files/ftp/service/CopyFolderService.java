...
public class CopyFolderService implements FTPRequestData {
    ...
    private static void copyFolder(FTPClient srcClient, FTPClient destClient, String srcFolderPath, String targetFolderPath) throws IOException, RuntimeException {
	...
	public int hashCode() {
	  return Objects.hash(
	        actionIfFolderExists, createTargetFolder, sourcePath, targetPath);
	}
