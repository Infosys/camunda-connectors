...
public class WriteFileService implements FTPRequestData {
  ...
  private boolean checkFileExists(String path, String filename, FTPClient client)
      throws IOException {
  ...
  public FTPResponse<String> invoke(FTPClient client) {
    try {
      if (!checkValidPath(folderPath, client)) {
        ...
        if (appendContent.equals("true")) os = client.appendFileStream(fileName);
        else os = client.storeFileStream(fileName);
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(content, other.content)
        ...
        && Objects.equals(appendContent, other.appendContent);
  }
}
