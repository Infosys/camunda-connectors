...
import com.infosys.camundaconnectors.db.mysql.BaseTest;
...
public class MySQLRequestTest extends BaseTest {
  ...
  public void replaceSecrets_shouldReplaceSecrets(String input) {
    // Given
    MySQLRequest<CreateTableService> requestData = gson.fromJson(input, MySQLRequest.class);
  ...
  void validate_shouldThrowExceptionWhenMethodIsBlank(String input) {
    // Given
    MySQLRequest<CreateTableService> requestData = new MySQLRequest<>();
