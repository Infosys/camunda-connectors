...
import com.infosys.camundaconnectors.db.postgresql.BaseTest;
...
public class PostgreSQLRequestTest extends BaseTest {
  ...
  public void replaceSecrets_shouldReplaceSecrets(String input) {
    // Given
    PostgreSQLRequest<CreateTableService> requestData =
        gson.fromJson(input, PostgreSQLRequest.class);
  ...
  @ParameterizedTest()
  @ValueSource(strings = {"", "  ", "     "})
  void validate_shouldThrowExceptionWhenOperationIsBlank(String input) {
    // Given
    PostgreSQLRequest<CreateTableService> requestData = new PostgreSQLRequest<>();
