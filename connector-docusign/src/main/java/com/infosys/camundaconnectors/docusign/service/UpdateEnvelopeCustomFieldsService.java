...
public class UpdateEnvelopeCustomFieldsService implements DocuSignRequestData {
  private static final Logger LOGGER =
      LoggerFactory.getLogger(UpdateEnvelopeCustomFieldsService.class);
  @NotNull private String envelopeId;
  private List<Map<String, Object>> textFields;
  private List<Map<String, Object>> listFields;
  DocuSignResponse<?> updateEnvelopeCustomeFieldResponse;
  ...
  public Response invoke(Authentication authentication, HttpServiceUtils httpService)
    ...
    Map<String, Object> response = httpService.putRequest(basePath, jsonPayLoad, authentication);
    errorHandler.checkForErrorDetails(response);
    updateEnvelopeCustomeFieldResponse = new DocuSignResponse<Map<String, Object>>(response);
    LOGGER.info("Response", updateEnvelopeCustomeFieldResponse);
    return updateEnvelopeCustomeFieldResponse;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(envelopeId, listFields, textFields, updateEnvelopeCustomeFieldResponse);
  }
  ...
  public boolean equals(Object obj) {
    ...
    UpdateEnvelopeCustomFieldsService other = (UpdateEnvelopeCustomFieldsService) obj;
    return Objects.equals(envelopeId, other.envelopeId)
        ...
        && Objects.equals(
            updateEnvelopeCustomeFieldResponse, other.updateEnvelopeCustomeFieldResponse);
  }
