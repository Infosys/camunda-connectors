...
public class CreateTableService implements MSSQLRequestData {
	...
	public MSSQLResponse invoke(Connection connection) throws SQLException {
		...
		try {
			...
			if (sqlException.getMessage().contains("There is already an object named")
					&& sqlException.getMessage().contains("in the database"))
	...
	public void createTable(Connection conn, String createTableQuery) throws SQLException {
