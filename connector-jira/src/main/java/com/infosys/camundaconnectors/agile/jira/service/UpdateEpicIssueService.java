...
public class UpdateEpicIssueService implements JIRARequestData {

  private static final Logger LOGGER = LoggerFactory.getLogger(UpdateEpicIssueService.class);
  ...
  public void deleteAttachment(
      File f, HttpResponse<JsonNode> attachmentsResponse, Authentication auth) {
  ...
  public Response invoke(Authentication auth) {
    try {
      ...
      String payload = "{ \"fields\": {\"issuetype\": {\"name\" : \"Epic\"}";
          ...
          while (!q.isEmpty()) {
            ...
            for (int i = 0; i < n; i++) {
              ...
              if (file.isDirectory()) {
                ...
                if (deleteFlag) {
                  deleteAttachment(file, attachmentResponse, auth);
                  deleteFlag = false;
                } else {
  ...
  public boolean equals(Object obj) {
    ...
    UpdateEpicIssueService other = (UpdateEpicIssueService) obj;
  ...
  public String toString() {
    return "UpdateEpicIssueService [issueKey="
        + issueKey
        + ", status="
        + status
        + ", summary="
